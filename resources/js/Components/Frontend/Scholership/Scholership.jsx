...
const Scholarship = ({scholarshipSchemes, scholarshipRates, key_instructions_eligibility}) => {
const SCHOLARSHIP_SCHEMES = scholarshipSchemes;
const RATE_OF_SCHOLARSHIP = scholarshipRates;
const SALIENT_INSTRUCTIONS = key_instructions_eligibility;

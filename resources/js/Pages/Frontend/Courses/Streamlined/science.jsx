...
const STATIC_DEGREE_FACTS_BY_TITLE = [
  { match: /b\.?sc.*(general|honours)/i, facts: STATIC_DEGREE_FACTS["bsc-general-honours"] },
  { match: /math|statistic/i, facts: STATIC_DEGREE_FACTS["bsc-maths-statistics"] },
  { match: /computer|it\b/i, facts: STATIC_DEGREE_FACTS["bsc-computer-science-it"] },
];
...
// Page
// ------------------------------------------------------------------
export default function ScienceDegree({ courseContent: courseContentProp }) {
  const { props } = usePage();
  ...
  return (
    <>
      <FrontendLayout>
        <HeroInner
          title={intro_heading || "Science Graduation Courses (B.Sc & Allied)"}
          breadcrumb="B.Sc & Allied"
        />
        <CoursesTabsBar tabs={TABS} activeId="bsc" />
          ...
          <div className="container">
            <div className="row g-4 align-items-start">
              <div className="col-12 col-lg-7">
                <h2 className="sectionHeading mb-3 d-flex align-items-center gap-2">
                  <BookOpen size={18} className="text-primary" />
                  <span>{intro_heading || "About Science Graduation Courses"}</span>
                </h2>

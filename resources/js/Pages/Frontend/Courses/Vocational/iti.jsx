...
// Expandable Trade Cards
function ITISectorGrid({ sectors }) {
  const [expanded, setExpanded] = useState({});
  const toggle = (id) => setExpanded((p) => ({ ...p, [id]: !p[id] }));
    ...
    return (
      <section className="py-4 py-md-5 bg-light">
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-7 text-center mb-5">
              <h2 className="sectionHeading mb-2">Types of Trades You Will Find in ITI / ITC</h2>
      ...
      <div className="container">
        ...
        <div className="row g-3 g-md-4">
          {sectors.map((sector) => {
            ...
            const visible = isExpanded || courses.length <= 4
              ? courses
              : courses.slice(0, 4);

            return (
              <div className="col-12 col-md-6 col-lg-4" key={sectorId}>
                <div className="sectionCard expandCard h-100">
                  <div className="d-flex justify-content-between mb-1">
                    <span className="badge badge-sm text-bg-primary">
...
// Admission Section
function AdmissionSection({ admissionHeading, admissionDescription, admissionInfo, nextSteps }) {
  return (
    <section className="py-4 py-md-5">
      <div className="container">
        <div className="row g-4 align-items-start">
          <div className="col-12 col-lg-7">
            <h2 className="sectionHeading mb-3">
              {admissionHeading || "Admission to ITI / ITC After Class 10"}
            </h2>
            <p className="sectionSub">
              {admissionDescription || "The Career Guidance Book clearly shows the entry route for vocational training after Class 10. Here is a simplified version to help students and parents understand the process."}
            </p>

            <ul className="list-unstyled small mb-3">
              {(admissionInfo || []).map((line, index) => (
  ...
  return (
    <section className="py-4 py-md-5">
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-lg-7 text-center mb-5">
            <h2 className="sectionHeading mb-2">Continue Exploring</h2>
            <p className="sectionSub mb-0">
              Discover more pathways based on your interest and future goals.
            </p>
          </div>
            ...
            <div className="col-12 col-md-6 col-lg-4" key={p.href}>
              <Link href={p.href} className="text-decoration-none">
                <div className="sectionCard h-100 hover-shadow transition">
                  <h3 className="h6 mb-2">{p.label}</h3>
...
export default function ITICoursesPage({ courseContent }) {
  // Debug log to see what we're getting
  console.log('=== ITICoursesPage Data ===');
  console.log('Course Content:', courseContent);

  // Extract data from courseContent
  const sectors = courseContent?.sectors || [];
  const snapshot = courseContent?.snapshot || [];
  const introHeading = courseContent?.intro_heading || "What Are ITI & ITC Courses?";
  const introDescription = courseContent?.intro_description || "Industrial Training Institutes (ITI) and Industrial Training Centres (ITC) are job-oriented training centres that focus on hands-on skills, workshop practice and practical knowledge.";
  const introDescriptionSecondary = courseContent?.intro_description_secondary || "These courses help students become employable early, build strong technical skills and explore freelancing or apprenticeship opportunities.";
  const admissionHeading = courseContent?.admission_heading || "Admission to ITI / ITC After Class 10";
  const admissionDescription = courseContent?.admission_description || "The Career Guidance Book clearly shows the entry route for vocational training after Class 10. Here is a simplified version to help students and parents understand the process.";

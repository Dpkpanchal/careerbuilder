...
export default function ForumHomePage({forumCategory,questions, counsellorsData}) {
  // const { forumCategory, setForumCategory } = usePage().props;
          ...
          <div className="row g-0">
            ...
            <div className="col-12 col-lg-3 d-none d-lg-block">
              <div className="card border-0 shadow-sm forum-side-card">
                <div className="card-body p-0 forum-side-scroll">
                  <ForumCategorySidebar forumCategory={selectedCategory} />
                </div>
              </div>
            </div>
            ...
            <div className="col-12 col-lg-6">
              <div className="forum-center d-flex flex-column">
                {/* Ask Question — only on timeline (index.js) */}
                <AskQuestionBox onAddThread={handleAddThread} forumCategory={selectedCategory} />

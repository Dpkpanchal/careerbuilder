...
export default function ScholarshipsOverviewPage({ overview }) {

  // Fallbacks in case the admin record hasn't been created yet
  const o = overview || {};
  const stats = o.stats || [];
  const quickAccessItems = o.quick_access_items || [];
  const rulesLeft = o.rules_left || [];
  const rulesRight = o.rules_right || [];
  const SCHEMES_AT_GLANCE = o.schemes || [];

  return (
    <>
    <FrontendLayout>
      <HeroInner
        title={o.hero_title || "Scholarships & Educational Support"}
        breadcrumb={o.hero_breadcrumb || "Scholarships → Overview"}
      />
            ...
            <div className="col-lg-8">
              <div className="sch-card sch-card-main h-100">
                <div className="d-flex align-items-center gap-3 mb-4">
                  ...
                  <div>
                    <h2 className="h4 mb-1">{o.intro_title}</h2>
                    <p className="sch-text-muted small mb-0">
                      {o.intro_subtitle}
                    </p>
                  </div>
                    ...
                    {stats.map((stat, i) => (
                      <div className="col-md-4" key={i}>
                        <div className="sch-stat">
                          ...
                          <span className="sch-stat-meta">{stat.meta}</span>
                        </div>
                      </div>
                    ))}
                  </div>

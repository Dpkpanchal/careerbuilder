...
// Page
// -------------------------------------------------------------
export default function HotelManagementUniversityPage({ examContents }) {

  const universityHotelExams = Array.isArray(examContents) ? examContents : [];
          ...
          <div className="row g-4 align-items-start">
            ...
            <div className="col-12 col-lg-5">
              <div className="sectionCard bg-light border">
                ...
                <dl className="row small mb-0">
                  <dt className="col-6">Exams listed</dt>
                  <dd className="col-6 mb-2">{universityHotelExams.length}</dd>

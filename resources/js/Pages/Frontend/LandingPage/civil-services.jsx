...
const getIcon = (iconName, size = 18, className = "") => {
  const icons = {
    ...
    Globe: <Globe size={size} className={className || "text-primary"} />,
    Users: <Users size={size} className={className || "text-primary"} />,
    BookOpen: <BookOpen size={size} className={className || "text-success"} />,
    Target: <Target size={size} className={className || "text-danger"} />,
    MapPin: <MapPin size={size} className={className || "text-success"} />,
    Award: <Award size={size} className={className || "text-warning"} />,
    TrendingUp: <TrendingUp size={size} className={className || "text-warning"} />,
  };
  return icons[iconName] || null;
};

export default function CivilServicesLandingPage({ content }) {
  ...
  const examStages = pageContent?.examStages || {};
  const optionalSubject = pageContent?.optionalSubject || {};
  ...
  return (
    <FrontendLayout>
      <HeroInner
        title="Civil Services Career Guide"
        breadcrumb="Civil Services Career Guide"
        description="Here you can explore all civil services-related links."
      />
        ...
        <div className="w-100 nitLightGradient">
          <div className="container py-4 py-md-5">
            <div className="d-flex flex-wrap align-items-center justify-content-between gap-3">
              <div style={{ maxWidth: 720 }}>
                <h1 className="section-heading mb-2">
                  {hero.title || "Civil Services"}{" "}
                  <span className="gradient-text">Career Guide</span>
                </h1>

                <div className="text-muted fw-semibold mb-3">
                  {hero.subtitle || "UPSC, WBCS, Exam Stages, Services & Preparation — A Complete Roadmap"}
                </div>

                <p className="text-muted mb-3" style={{ lineHeight: 1.7 }}>
                  {hero.description || "A career in civil services is one of the most ambitious and respected paths in India — but it demands years of disciplined preparation. UPSC CSE, WBCS, exam stages, optional subjects, syllabus depth, and the reality of multiple attempts can make it hard to know where to begin. This page simplifies everything into one clear place."}
                </p>

                <p className="text-muted mb-0" style={{ lineHeight: 1.7 }}>
                  {hero.description2 || "Whether you are a student in graduation starting to think about civil services, or someone who has already begun preparation and wants to understand the full picture — you'll find clear pathways, exam breakdowns, service options, and honest preparation guidance here."}
                </p>
              </div>
            ...
            <div className="container">
              <div className="row justify-content-start">
                <div className="col-lg-9">
                  <div className="mb-4 mb-lg-5">
                    <h2 className="section-heading mb-3">
                      <span className="gradient-text">{primaryExam.heading?.split(':')[0] || 'UPSC CSE'}:</span>{" "}
                      {primaryExam.heading?.split(':')[1] || "The Main Civil Services Exam"}
                    </h2>
              ...
              <div className="row justify-content-start">
                <div className="col-lg-12">
                  ...
                  {/* Services allocated through UPSC CSE */}
                  {primaryExam.services && primaryExam.services.length > 0 && (
                    <div className="mb-4 mb-lg-5">
                      <h3 className="h5 fw-semibold mb-3">Services allocated through UPSC CSE</h3>
                      <p className="text-muted" style={{ fontSize: "1.02rem", lineHeight: 1.9 }}>
                        {primaryExam.servicesDescription || "The service you are allocated depends on your final merit rank and your preference list. Higher ranks unlock the most sought-after services. All services offer significant responsibility, authority, and social impact."}
                      </p>
                      <div className="row g-3 mt-1">
                        {primaryExam.services.map((service, index) => (
                  ...
                  {/* WBCS Section */}
                  {primaryExam.stateExams && (
                    <div className="mb-4 mb-lg-5">
                      <h3 className="h5 fw-semibold mb-3">{primaryExam.stateExams.title}</h3>
                      <p className="text-muted mb-3" style={{ fontSize: "1.02rem", lineHeight: 1.9 }}>
                        {primaryExam.stateExams.description}
                      </p>
                      <div className="row g-3">
                        <div className="col-md-4">
                          <div className="p-3 rounded-3 border bg-white h-100">
                            <div className="fw-semibold mb-1">Exam Pattern</div>
                            <div className="small text-muted">{primaryExam.stateExams.examPattern}</div>
                          </div>
                        </div>
                        <div className="col-md-4">
                          <div className="p-3 rounded-3 border bg-white h-100">
                            <div className="fw-semibold mb-1">Posts Allocated</div>
                            <div className="small text-muted">{primaryExam.stateExams.postsAllocated}</div>
                          </div>
                        </div>
                        <div className="col-md-4">
                          <div className="p-3 rounded-3 border bg-white h-100">
                            <div className="fw-semibold mb-1">Key Difference from UPSC</div>
                            <div className="small text-muted">{primaryExam.stateExams.keyDifference}</div>
                          </div>
                        </div>
                      </div>
                      {primaryExam.stateExams.officialWebsite && (
                        <div className="mt-3">
                          <a
                            href={primaryExam.stateExams.officialWebsite}
                            target="_blank"
                            rel="noreferrer"
                            className="iitWebsiteLink d-inline-flex align-items-center gap-1"
                          >
                            <span className="small">WBPSC Official Website — {primaryExam.stateExams.officialWebsite}</span>
                          </a>
                        </div>
                      )}
                    </div>
                  ...
                  {primaryExam.whoShouldFocusPoints && (
                    <div className="mb-4 mb-lg-5">
                      <h3 className="h5 fw-semibold mb-3">Who should seriously pursue civil services</h3>
                      <p className="text-muted mb-0" style={{ fontSize: "1.02rem", lineHeight: 1.9 }}>
                        {primaryExam.whoShouldFocusIntro || "Civil services is not the right choice for everyone — and knowing this early saves years. It suits students who are genuinely motivated by public administration, are comfortable with a multi-year preparation commitment, and can stay focused through uncertainty and repeated cycles."}
                      </p>
                      <div className="mt-3">
                        <ul className="text-muted mb-0" style={{ lineHeight: 2 }}>
                  ...
                  {primaryExam.prepPlan && primaryExam.prepPlan.length > 0 && (
                    <div>
                      <h3 className="h5 fw-semibold mb-3">A practical UPSC preparation plan (simple & honest)</h3>
                      <div className="d-grid gap-4">
        ...
        {examStages.title && (
          <section className="pt-lg-5 pb-lg-5">
            <div className="container">
              <SectionTitle
                icon={<Target size={18} className="text-danger" />}
                title={examStages.title}
                subtitle={examStages.subtitle}
              />

              <div className="mt-4 mt-lg-5">
                <div className="row g-4">
                  {examStages.stages?.map((stage, index) => {
                    const colorMap = {
                      primary: "var(--bs-primary)",
                      success: "var(--bs-success)",
                      warning: "var(--bs-warning)",
                    };
                    const bgColor = colorMap[stage.color] || "var(--bs-primary)";
        ...
        {optionalSubject.title && (
          <section className="mt-4 mt-md-5">
            <div className="container">
              <SectionTitle
                icon={<BookOpen size={18} className="text-success" />}
                title={optionalSubject.title}
                subtitle={optionalSubject.subtitle}
              />

              <div className="p-4 p-lg-5 rounded-4 border bg-white shadow-sm">
                <p className="text-muted mb-4" style={{ lineHeight: 1.9 }}>
                  {optionalSubject.description}
                </p>
                ...
                <div className="row g-4">
                  <div className="col-md-6">
                    <div className="fw-semibold mb-2">Factors to consider</div>
                    <ul className="text-muted mb-0" style={{ lineHeight: 2 }}>
                      {optionalSubject.factors?.map((factor, index) => (
                        <li key={index} dangerouslySetInnerHTML={{ __html: factor }} />
                      ))}
                    </ul>
                  </div>
                  ...
                  <div className="col-md-6">
                    <div className="fw-semibold mb-2">Commonly chosen optionals</div>
                    <div className="row g-2">
                      {optionalSubject.commonOptionals?.map((opt, index) => (
              ...
              <div className="p-4 p-lg-5 rounded-4 border bg-white shadow-sm">
                ...
                <div className="row g-4">
                  <div className="col-md-6">
                    <div className="fw-semibold mb-2">What the journey typically looks like</div>
                    <ul className="text-muted mb-0" style={{ lineHeight: 2 }}>
                      {realityCheck.journey?.map((item, index) => (
                  ...
                  <div className="col-md-6">
                    <div className="fw-semibold mb-2">What helps aspirants succeed</div>
                    <ul className="text-muted mb-0" style={{ lineHeight: 2 }}>
                      {realityCheck.successFactors?.map((item, index) => (
                        <li key={index} dangerouslySetInnerHTML={{ __html: item }} />
                      ))}
                    </ul>
                  </div>

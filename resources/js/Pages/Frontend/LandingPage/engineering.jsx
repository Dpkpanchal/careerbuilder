...
const getIcon = (iconName, size = 18, className = "") => {
  const icons = {
    Cpu: <Cpu size={size} className={className || "text-primary"} />,
    ...
    Code: <Code size={size} className={className || "text-success"} />,
    Wrench: <Wrench size={size} className={className || "text-warning"} />,
    Zap: <Zap size={size} className={className || "text-danger"} />,
    Layers: <Layers size={size} className={className || "text-primary"} />,
    PenTool: <PenTool size={size} className={className || "text-danger"} />,
    FlaskConical: <FlaskConical size={size} className={className || "text-success"} />,
  };
  return icons[iconName] || null;
};

export default function EngineeringLandingPage({ content }) {
  ...
  return (
    <FrontendLayout>
      <HeroInner
        title="Career Guide - Engineering & Technology"
        breadcrumb="Career Guide - Engineering & Technology"
        description="Here you can explore all engineering-related links."
      />
        ...
        <div className="w-100 nitLightGradient">
          <div className="container py-4 py-md-5">
            <div className="d-flex flex-wrap align-items-center justify-content-between gap-3">
              <div style={{ maxWidth: 720 }}>
                <h1 className="section-heading mb-2">
                  {hero.title || "Engineering & Technology"}{" "}
                  <span className="gradient-text">Career Guide</span>
                </h1>
                ...
                <p className="text-muted mb-3" style={{ lineHeight: 1.7 }}>
                  {hero.description || "Planning a career in engineering can feel overwhelming — B.Tech, Diploma, Polytechnic, dozens of branches, entrance exams like JEE Main, WBJEE, IIT vs NIT vs state colleges, and counselling rounds. This page brings everything together in one place."}
                </p>

                <p className="text-muted mb-0" style={{ lineHeight: 1.7 }}>
                  {hero.description2 || "Whether you're exploring options after Class 10 (Polytechnic route) or preparing seriously after Class 12 (PCM) for a B.Tech degree, you'll find clear pathways, branch choices, exam guidance, college types, and direct links to detailed pages across the portal — so you can plan your next step with confidence."}
                </p>
              </div>
            ...
            <div className="container">
              <div className="row justify-content-start">
                <div className="col-lg-9">
                  <div className="mb-4 mb-lg-5">
                    <h2 className="section-heading mb-3">
                      <span className="gradient-text">{primaryExam.heading?.split(':')[0] || 'JEE'}:</span>{" "}
                      {primaryExam.heading?.split(':')[1] || "The Main Engineering Entrance Exam"}
                    </h2>
                ...
                <div className="col-lg-12">
                  <div className="p-4 p-lg-5 rounded-4 border bg-white shadow-sm mb-4 mb-lg-5">
                    ...
                    <div className="d-flex flex-wrap align-items-center gap-4">
                      ...
                      {primaryExam.advancedWebsite && (
                        <div>
                          <div className="small text-muted">JEE Advanced</div>
                          <a
                            href={primaryExam.advancedWebsite}
                            target="_blank"
                            rel="noreferrer"
                            className="iitWebsiteLink d-inline-flex align-items-center gap-1 mt-1"
                          >
                            <span className="small">{primaryExam.advancedWebsite}</span>
                          </a>
                        </div>
                      )}
                    </div>
                  ...
                  {primaryExam.unlocks && primaryExam.unlocks.length > 0 && (
                    <div className="mb-4 mb-lg-5">
                      <h3 className="h5 fw-semibold mb-3">What JEE unlocks for you</h3>
                      <p className="text-muted" style={{ fontSize: "1.02rem", lineHeight: 1.9 }}>
                        {primaryExam.unlocksDescription || "JEE is not just 'one exam' — it is a tiered gateway to multiple engineering pathways. Your JEE Main score opens doors to NITs, IIITs, and state colleges, while a top score in JEE Advanced gives access to the IITs — India's most prestigious engineering institutions."}
                      </p>
                      <ul className="text-muted mb-0" style={{ lineHeight: 2 }}>
                  ...
                  {primaryExam.whoShouldFocusPoints && (
                    <div className="mb-4 mb-lg-5">
                      <h3 className="h5 fw-semibold mb-3">Who should focus on JEE seriously</h3>
                      <p className="text-muted mb-0" style={{ fontSize: "1.02rem", lineHeight: 1.9 }}>
                        {primaryExam.whoShouldFocusIntro || "JEE rewards consistent, concept-based preparation. It is best suited for students who are strong in Mathematics and willing to practise problem-solving regularly over a 1–2 year preparation cycle."}
                      </p>
                      <div className="mt-3">
                        <ul className="text-muted mb-0" style={{ lineHeight: 2 }}>
                  ...
                  {primaryExam.prepPlan && primaryExam.prepPlan.length > 0 && (
                    <div>
                      <h3 className="h5 fw-semibold mb-3">A practical JEE preparation plan (simple & effective)</h3>
                      <div className="d-grid gap-4">
              ...
              <div className="mt-4 mt-lg-5">
                <div className="row g-4">
                  ...
                  {pathways.after10 && (
                    <div className="col-lg-12">
                      <div className="fw-bold d-flex align-items-center gap-2 mb-2">
                        {pathways.after10.title}
                      </div>
                      <p className="text-muted mb-3" style={{ lineHeight: 1.9 }}>
                        {pathways.after10.description}
                      </p>
                      <ul className="text-muted mb-3" style={{ lineHeight: 2 }}>
                        {pathways.after10.points?.map((point, index) => (
                          <li key={index}>{point}</li>
                        ))}
                      </ul>
                      <div className="d-flex gap-3 flex-wrap">
                        {pathways.after10.links?.map((link, index) => (
                          <LinkRow
                            key={index}
                            label={link.label}
                            meta={link.meta}

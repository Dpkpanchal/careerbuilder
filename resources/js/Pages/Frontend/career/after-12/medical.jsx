...
import ArtsOverviewTab from "@/components/Frontend/AfterClass12/MedicalTab";
...
export default function AfterClass12ArtsPage() {
  ...
  return (
    <div className={styles.pageContainer}>
      ...
      <HeroInner title="Career Options — After Class 12 (Medical/Paramedical)" breadcrumb="After Class 12 • Medical/Paramedical" />

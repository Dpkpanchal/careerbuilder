...
const JobGroupCreate = ({ sectors }) => {
    ...
    // "After Class 8" rows carry their own recruiter + website per row,
    // instead of inheriting it from the group.
    ...
    const submit = (e) => {
        ...
        post("/admin/job-groups");

    };

    return (

        <AdminLayout header="Create Job Group">
                    ...
                    <div className="col-md-10">
                        ...
                        <div className="card">
                            ...
                            <div className="card-header">
                                <h3 className="card-title">Create Job Group</h3>
                            </div>

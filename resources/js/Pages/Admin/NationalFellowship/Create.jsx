...
const NationalFellowshipCreate = ({ categories }) => {
    ...
    const submit = (e) => {
        ...
        post("/admin/national-fellowships");

    };

    return (

        <AdminLayout header="Create National Fellowship">

            <Head title="Create National Fellowship" />
                    ...
                    <div className="col-md-8">
                        ...
                        <div className="card">
                            ...
                            <div className="card-header">
                                <h3 className="card-title">Create National Fellowship</h3>
                            </div>
...
export default NationalFellowshipCreate;

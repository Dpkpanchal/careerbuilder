...
export default function Index({ courses, filters = {} }) {
    ...
    const deleteItem = (id) => {
        if (confirm("Delete this course content?")) {
            router.delete(`/admin/course-content/${id}`, {
                preserveScroll: true,
            });
        }
    };
    ...
    const toggleStatus = (id) => {
        router.patch(`/admin/course-content/${id}/toggle-status`, {}, {
            preserveScroll: true,
        });
    };
    ...
    const applyFilters = (overrides = {}) => {
        ...
        router.get("/admin/course-content", params, {
            preserveScroll: true,
            preserveState: true,
        });
    };
    ...
    const clearFilters = () => {
        setNameSearch("");
        setSelectedStatus("");
        router.get("/admin/course-content", {}, {
            preserveScroll: true,
            preserveState: true,
        });
    };
    ...
    return (
        ...
        <AdminLayout header="Course Content">
                    ...
                    <div className="card-header">
                        ...
                        <div className="row align-items-center">
                            ...
                            <div className="col-md-6 text-right">
                                ...
                                <Link
                                    href="/admin/course-content/create"
                                ...
                                rows.map((item, index) => (
                                    ...
                                    <tr key={item.id}>
                                        ...
                                        <td className="text-center">
                                            ...
                                            <Link
                                                href={`/admin/course-content/${item.id}/edit`}

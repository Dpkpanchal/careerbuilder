        ...
        sections: [
          {
            ...
            links: [
              ...
              { label: "After Class 12 • Engineering", href: route('After.Class.Twelve.Engineering') },
              { label: "After Class 12 • Medical/Paramedical", href: route('After.Class.Twelve.Medical') },
...
// =========================
{
  ...
  { key: "forum", label: "Scholarship", href: route('scholarship.overview'), noDropdown: true },
  { key: "about", label: "Counsellors Directory", href: route('more.counsellorsDirectory'), noDropdown: true },
  { key: "jobs", label: "Jobs Opportunities", href: route('more.jobsOpportunities'), noDropdown: true },
  { key: "schemes", label: "Minority Schemes ", href: route('more.minoritySchemes'), noDropdown: true },
  { key: "hostel", label: "Waqf Run Hostel", href: route('more.waqfRunHostel'), noDropdown: true },
  { key: "support", label: "Admission Support", href: route('more.admissionSupport'), noDropdown: true },
  { key: "coaching", label: "Coaching Support", href: route('more.coachingSupport'), noDropdown: true },
  { key: "links", label: "Important Web Links", href: route('more.importantWebLinks'), noDropdown: true },
];

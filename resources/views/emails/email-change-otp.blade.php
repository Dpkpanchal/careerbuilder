...
>
        ...
        <!-- Content -->
        <div class="content">
            <h1 class="greeting">Email Change OTP</h1>
            
            <p class="message">
                We received a request to change your email address. Use the verification code below to continue.
            </p>
            ...
            <p class="message" style="font-size: 13px; color: #a0aec0; margin-top: 8px;">
                This code is valid for 10 minutes. Enter it on the verification page to change your email.
            </p>
        </div>

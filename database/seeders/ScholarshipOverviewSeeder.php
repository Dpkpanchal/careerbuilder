...
class ScholarshipOverviewSeeder extends Seeder
{
    public function run(): void
    {
        ScholarshipOverview::updateOrCreate(
            ['id' => 1],
            [
                ...
                'quick_access_items' => [
                    [
                        'text' => 'Apply online on the National Scholarship Portal',
                        'link_url' => 'https://scholarships.gov.in',
                        'link_label' => 'scholarships.gov.in',
                    ],
                ],

import{j as e,H as l,L as n,r as d}from"./app-CaCW13Kp.js";import{A as c}from"./AdminLayout-Dx8e-5PL.js";function x({scholarships:s,filters:t}){const i=a=>{confirm("Delete this record?")&&d.delete(route("admin.scholarship-overview-table.destroy",a),{preserveScroll:!0})};return e.jsxs(c,{children:[e.jsx(l,{title:"Scholarship Overview Table"}),e.jsx("style",{children:` .pagination-wrap {
                        display: flex;
